---
description: 管理 git worktree 工作流（创建/进入/退出/状态/授权）。加载 worktree-workflow 技能获取完整指引。
---
...
| `/worktree authorize-main <reason>` | `echo '{"reason":"<reason>"}' | node <base>/../../scripts/wt.mjs authorize-main` |
